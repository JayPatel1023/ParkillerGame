...
// Off for client-facing builds. All five boards' outer loops and corridors are now complete and
// verified (see generated-boards.json history) - flip both back to true only for local
// verification work, never for a build meant to be shown to Carlos.
