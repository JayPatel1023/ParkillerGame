...
// On for verification. Must be turned back off (false / empty Set) before any client-facing
// deploy - it was accidentally left on once already and the client mistook the debug lines
// themselves for broken track data.
